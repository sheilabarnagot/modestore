        ...
        <g transform="translate(825.000000, 1100.000000)">
          ...
          >
            ...
            <g id="Clothing/Hoodie" transform="translate(0.000000, 170.000000)">
              ...
              <mask id="react-mask-248" fill="white">
                <use xlink:href="#react-path-247" />
              </mask>
              <use
                id="Hoodie"
                fill="#B7C1DB"
                fill-rule="evenodd"
                xlink:href="#react-path-247"
              />
              <g
            ...
            <g id="Top" stroke-width="1" fill-rule="evenodd">
              ...
              <mask id="react-mask-187" fill="white">
                <use xlink:href="#react-path-189" />
              </mask>
              <g id="Mask" />
              <g id="Top/Long-Hair/Straight" mask="url(#react-mask-187)">
                <g transform="translate(-1.000000, 0.000000)">
                  ...
                  >
                    <mask id="react-mask-188" fill="white">
                      <use xlink:href="#react-path-190" />
                    </mask>
                    <use
                      id="Mask-Hair"
                      fill="#944F23"
                      xlink:href="#react-path-190"
                    />
                    <g
                      id="Skin/👶🏽-03-Brown"
                      mask="url(#react-mask-188)"
                      fill="#D6B370"
                    >
                      <g transform="translate(0.000000, 0.000000) " id="Color">
                        <rect x="0" y="0" width="264" height="280" />
