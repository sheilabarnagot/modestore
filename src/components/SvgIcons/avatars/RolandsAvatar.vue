        ...
        <g transform="translate(825.000000, 1100.000000)">
          ...
          >
            ...
            >
              ...
              <mask id="react-mask-148" fill="white">
                <use xlink:href="#react-path-147" />
              </mask>
              <use
                id="Clothes"
                fill="#E6E6E6"
                fill-rule="evenodd"
                xlink:href="#react-path-147"
              />
              <g
                id="Color/Palette/Gray-01"
                mask="url(#react-mask-148)"
                fill-rule="evenodd"
                fill="#929598"
              >
            ...
            <g id="Top" stroke-width="1" fill-rule="evenodd">
              ...
              <mask id="react-mask-135" fill="white">
                <use xlink:href="#react-path-137" />
              </mask>
              <g id="Mask" />
              <g id="Top/Short-Hair/Short-Waved" mask="url(#react-mask-135)">
                <g transform="translate(-1.000000, 0.000000)">
                  <mask id="react-mask-134" fill="white">
                    <use xlink:href="#react-path-136" />
                  </mask>
                  <use
                    id="Short-Hair"
                    stroke="none"
