          ...
          >
            ...
            >
              ...
              <mask id="react-mask-304" fill="white">
                <use xlink:href="#react-path-303" />
              </mask>
              <use
                id="Clothes"
                fill="#E6E6E6"
                fill-rule="evenodd"
                xlink:href="#react-path-303"
              />
              <g
            ...
            >
              <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                ...
                <mask id="react-mask-324" fill="white">
                  <use xlink:href="#react-path-323" />
                </mask>
                <use
                  id="Mouth"
                  ...
                  fill="#000000"
                  fill-rule="evenodd"
                  xlink:href="#react-path-323"
                />
                <rect
                  id="Teeth"
                  fill="#FFFFFF"
                  fill-rule="evenodd"
                  mask="url(#react-mask-324)"
                  x="39"
                  y="2"
                  width="31"
                  height="16"
            ...
            <g id="Top" stroke-width="1" fill-rule="evenodd">
              ...
              <g id="Mask" />
              <g id="Top/Long-Hair/Straight" mask="url(#react-mask-155)">
                <g transform="translate(-1.000000, 0.000000)">
                  ...
                  >
                    <mask id="react-mask-156" fill="white">
                      <use xlink:href="#react-path-158" />
                    </mask>
                    <use fill="#272C2E" xlink:href="#react-path-158" />
                    <g
                      id="Skin/👶🏽-03-Brown"
                    ...
                    >
                      ...
                      >
                        <g id="Shade">
                          ...
                          />
                          <use
                            fill="url(#react-linear-gradient-336)"
                            fill-rule="evenodd"
                            xlink:href="#react-path-333"
